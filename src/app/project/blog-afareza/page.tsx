...
export default function BlogAfareza() {
  ...
  // KODE YANG KURANG: State untuk melacak indeks foto aktif dan status hover slider
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-24 lg:pt-28">
        ...
        <section className="text-center md:text-left mb-6 border-b-4 border-black pb-6">
          ...
          <div className="flex flex-wrap gap-2 justify-center md:justify-start select-none">
            {["Website", "Content Platform", "Blog"].map((tag) => (
            ...
            >
              {screenshots.map((src, index) => (
                ...
                >
                  <Image
                    src={src}
                    alt={`Blog Highlight Slide ${index + 1}`}
                    fill
                    priority={index === 0}
        ...
        <div className="grid md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-8 bg-zinc-950 border-4 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_#000] space-y-4">
            ...
            <div className="text-zinc-400 text-xs sm:text-sm leading-relaxed tracking-wide text-justify space-y-4">
              <p>
                <span className="text-white font-bold">Afareza Studio Blog</span> is a dedicated content platform custom-engineered to deploy digital asset tutorials, multi-stack developer optimization logs, and high-fidelity project updates straight from our core laboratory.
              </p>
              <p>
                The production node prioritizes cross-linking article vectors dynamically, enabling structured indexing of complex technical documentation. It serves as a unified transparent communication pipeline mapping engineering ideas directly to active peer communities.
              </p>
            </div>
          </div>
            ...
            <div className="bg-zinc-950 border-4 border-black p-5 shadow-[4px_4px_0px_0px_#000]">
              ...
              <ul className="text-[11px] font-bold uppercase text-zinc-400 space-y-2.5 tracking-wide">
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> SEO_Optimized_Core
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Query_Search_Module
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Dynamic_MDX_Hydration
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Fluid_Mobile_Viewport
                </li>
              </ul>
            </div>
