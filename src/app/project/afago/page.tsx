        ...
        <div className="grid md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-8 bg-zinc-950 border-4 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_#000] space-y-4">
            ...
            <div className="text-zinc-400 text-xs sm:text-sm leading-relaxed tracking-wide text-justify space-y-4">
              <p>
                <span className="text-white font-bold">Afago</span> is a comprehensive mobile solution for renting cars and motorbikes. The platform streamlines the rental process by integrating a secure Down Payment (DP) system using the Midtrans payment gateway.
              </p>
              <p>
            ...
            <div className="bg-zinc-950 border-4 border-black p-5 shadow-[4px_4px_0px_0px_#000]">
              ...
              <ul className="text-[11px] font-bold uppercase text-zinc-400 space-y-2.5 tracking-wide">
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Midtrans Payment Integration
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Multi-brand Vehicle Catalog
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Advanced Booking System
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Seller & Customer Dashboards
                </li>
              </ul>
            </div>
