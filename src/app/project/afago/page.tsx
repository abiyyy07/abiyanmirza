...
import { FaChevronLeft, FaTimes, FaLayerGroup, FaCode, FaRocket, FaCreditCard } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-[#030712] text-gray-100 selection:bg-purple-500/30">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 lg:py-24">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-purple-400 font-medium mb-8">Vehicle Rental Application</p>
          
          <div className="flex flex-wrap justify-center gap-3">
            {["Mobile App", "Flutter", "Rental System", "Payment Gateway"].map((tag) => (
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-3xl backdrop-blur-sm">
              ...
              <p className="text-gray-400 leading-relaxed text-lg">
                Afago is a comprehensive mobile solution for renting cars and motorbikes. The platform streamlines the rental process by integrating a secure Down Payment (DP) system using the Midtrans payment gateway. 
                <br /><br />
                Users can browse through various vehicle brands, each with detailed types and specifications. The booking engine allows customers to select precise dates and duration, while the admin dashboard provides easy management for sellers to handle orders and inventory effectively.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-gray-900/40 border border-gray-800 p-6 rounded-3xl">
              ...
              <div className="flex flex-wrap gap-2">
                {["Flutter", "Dart", "Firebase", "GetX", "Midtrans"].map((tech) => (
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-6 rounded-3xl">
              ...
              <ul className="text-sm text-gray-400 space-y-3">
                <li className="flex items-center gap-2">✓ Midtrans Payment Integration</li>
                <li className="flex items-center gap-2">✓ Multi-brand Vehicle Catalog</li>
                <li className="flex items-center gap-2">✓ Advanced Booking System</li>
                <li className="flex items-center gap-2">✓ Seller & Customer Dashboards</li>
              </ul>
            </div>
          </div>
        </div>
