    ...
    <div className="min-h-screen bg-[#030712] text-gray-100 selection:bg-purple-500/30">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 lg:py-24">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-purple-400 font-medium mb-8">Official Website Record and Identification Division SAPD SSRP</p>
          
          <div className="flex flex-wrap justify-center gap-3">
            {["Internal Web", "Next JS", "Database System", "Division Dashboard"].map((tag) => (
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-3xl backdrop-blur-sm">
              ...
              <p className="text-gray-400 leading-relaxed text-lg">
                The <strong>RID (Record and Identification)</strong> website is a specialized internal platform built for the SAPD division within the SSRP community. It serves as a centralized database for member identification, record-keeping, and operational tracking.
                <br /><br />
                This system focuses on high data integrity and efficient retrieval. It allows authorized personnel to manage and search records swiftly, about any registered license like Heavy Truck, Lorry Truck CGC and etc.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-6 rounded-3xl">
              ...
              <ul className="text-sm text-gray-400 space-y-3">
                <li className="flex items-center gap-2">✓ Centralized Record Database</li>
                <li className="flex items-center gap-2">✓ Advanced Search & Identification</li>
                <li className="flex items-center gap-2">✓ Member Data Management</li>
                <li className="flex items-center gap-2">✓ Secure Internal Dashboard</li>
              </ul>
            </div>
          </div>
        </div>
