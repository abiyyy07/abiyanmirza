...
import { FaChevronLeft, FaTimes, FaLayerGroup, FaCode, FaRocket, FaMagic, FaUsers } from "react-icons/fa";
import Link from "next/link";

export default function Invitya() {
    ...
    <div className="min-h-screen bg-[#030712] text-gray-100 selection:bg-purple-500/30">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 lg:py-24">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-purple-400 font-medium mb-8">Premium Digital Invitation SaaS Platform</p>
          
          <div className="flex flex-wrap justify-center gap-3">
            {["Web App", "Next JS", "SaaS", "Digital Assets"].map((tag) => (
        ...
        <section className="mb-16">
          <div className="flex overflow-x-auto gap-4 pb-6 snap-x hide-scrollbar mask-fade-edges">
            {screenshots.map((src, index) => (
              ...
              >
                <Image
                  src={src}
                  alt={`Invitya Screenshot ${index + 1}`}
                  fill
          ...
          <p className="text-center text-gray-500 text-xs mt-2 italic flex items-center justify-center gap-2">
            <span>← Scroll to see templates</span>
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-3xl backdrop-blur-sm">
              ...
              <p className="text-gray-400 leading-relaxed text-lg">
                <strong>Invitya</strong> is a Software as a Service (SaaS) platform designed to simplify the creation of elegant digital invitations. It empowers users to build and customize their own invitations through an intuitive interface without needing any technical background.
                <br /><br />
                We focused to easy to use, you can just choose template or theme what you want. And dont needed to switch acount each other, you just invite them to join and manage your guest with collaboration system.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-6 rounded-3xl">
              ...
              <ul className="text-sm text-gray-400 space-y-3">
                <li className="flex items-center gap-2">✓ Advanced Customization Tools</li>
                <li className="flex items-center gap-2">✓ Premium Template Library</li>
                <li className="flex items-center gap-2">✓ Integrated Guest Management</li>
