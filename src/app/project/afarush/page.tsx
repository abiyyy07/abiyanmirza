        ...
        <div className="grid md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-8 bg-zinc-950 border-4 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_#000] space-y-4">
            ...
            <div className="text-zinc-400 text-xs sm:text-sm leading-relaxed tracking-wide text-justify space-y-4">
              <p>
                <span className="text-white font-bold">Afarush</span> is a mobile application dedicated to fast-typing competitions. While typing tests are commonly found on desktops, Afarush brings this competitive experience to mobile users.
              </p>
              <p>
            ...
            <div className="bg-zinc-950 border-4 border-black p-5 shadow-[4px_4px_0px_0px_#000]">
              ...
              <ul className="text-[11px] font-bold uppercase text-zinc-400 space-y-2.5 tracking-wide">
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Real-time Multiplayer Battle
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Solo Training Mode
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Global Ranking & Leaderboards
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> WPM Tracking
                </li>
              </ul>
            </div>
