    ...
    <div className="min-h-screen bg-[#030712] text-gray-100 selection:bg-purple-500/30">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 lg:py-24">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-purple-400 font-medium mb-8">Realtime Location Sharing App</p>
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="bg-gray-900/40 border border-gray-800 p-8 rounded-3xl backdrop-blur-sm">
              ...
              <p className="text-gray-400 leading-relaxed text-lg">
                GeoFarezly is a mobile application for sharing locations with friends in real time. 
                GeoFarezly provides the accuracy of the displayed location. For privacy, you can also 
                hide your location from your friends so that they are not seen.
                <br /><br />
                The friendship feature is the main key; search by UniqueID, send a request, 
                and once accepted, you can see each other's positions on a highly customizable map interface.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900/40 border border-gray-800 p-6 rounded-3xl">
              ...
              <ul className="text-sm text-gray-400 space-y-3">
                <li className="flex items-center gap-2">✓ Realtime Map Tracking</li>
                <li className="flex items-center gap-2">✓ Privacy Mode (Hide Location)</li>
                <li className="flex items-center gap-2">✓ Custom Map Themes</li>
                <li className="flex items-center gap-2">✓ UniqueID Friend System</li>
              </ul>
            </div>
          </div>
        </div>
