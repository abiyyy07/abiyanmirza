...
export default function PBIMap() {
  ...
  const screenshots = [
    "/projek/pbimap/PBIM1.png",
    "/projek/pbimap/PBIM2.png",
    "/projek/pbimap/PBIM3.png",
  ];
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-24 lg:pt-28">
        ...
        <section className="text-center md:text-left mb-6 border-b-4 border-black pb-6">
          ...
          <p className="text-sm md:text-base text-zinc-400 uppercase tracking-wide font-medium mb-6">
            Simple address finder map application
          </p>
          
          <div className="flex flex-wrap gap-2 justify-center md:justify-start select-none">
            {["Web App", "Next JS", "MAP", "Route Address"].map((tag) => (
            ...
            >
              {screenshots.map((src, index) => (
                ...
                >
                  <Image
                    src={src}
                    alt={`PBI Map Screenshot ${index + 1}`}
                    fill
                    priority={index === 0}
        ...
        <div className="grid md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-8 bg-zinc-950 border-4 border-black p-6 md:p-8 shadow-[4px_4px_0px_0px_#000] space-y-4">
            ...
            <div className="text-zinc-400 text-xs sm:text-sm leading-relaxed tracking-wide text-justify space-y-4">
              <p>
                <span className="text-white font-bold">PBI Map</span> is a simple website application designed to find and create the fastest route to the address of the surrounding housing complex.
              </p>
              <p>
                This application was created due to the change from the manual map reading process by 'At-Tauhid Mosque Youth' to increase the efficiency of activities carried out related to residents' home addresses.
              </p>
            </div>
          </div>
            ...
            <div className="bg-zinc-950 border-4 border-black p-5 shadow-[4px_4px_0px_0px_#000]">
              ...
              <ul className="text-[11px] font-bold uppercase text-zinc-400 space-y-2.5 tracking-wide">
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> HP map display
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Responsive UI
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Finding the fastest route
                </li>
                <li className="flex items-center gap-2 text-zinc-300">
                  <span className="text-emerald-400">&gt;</span> Real-time location
                </li>
              </ul>
            </div>
